...
return [
    ...
    */
    ...
    'custom' => [
        'organization_id' => [
            'numeric' => 'Ұйымның атауы толық болуы керек'
        ],
        'coverage' => [
            'min' => 'Қамтуды таңдаңыз'
        ],
        'city' => [
            'numeric' => 'Қаланың атауын таңдаңыз'
        ],
        'login' => [
            'regex'   => 'Логин тек қана латын әріптерден және сандардан тұруы керек' 
        ],
        'roles_count' => [
            'required' => 'Қолданушыға кем дегенде бір рөл таңдау қажет',
        ],
    ],
